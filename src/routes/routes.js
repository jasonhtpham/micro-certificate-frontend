...
import { Login, Register, Home, MobileMenu, FourOFour, Example, CreateCert } from 'views';
...
export const AppRoutes = (props) => {
  ...
  return (
    <Switch>
      ...
      <Route exact path='/createCert' render={() => ((loginStatus === false ? <Redirect to={{ pathname: '/login' }}  {...props} /> : <Layout> <CreateCert  {...props} /></Layout>))} />
